        ...
        <div
          ...
          className={cn(
            ...
            a.earned
              ...
              : "border-gray-100 dark:border-zinc-800 bg-gray-50/50 dark:bg-zinc-900/30 opacity-60"
          )}
          title={a.description}
        >
          <div
            className={cn(
              ...
              a.earned ? "bg-heliotrope/15 text-affair dark:text-heliotrope" : "bg-gray-100 dark:bg-zinc-800 text-gray-400 dark:text-zinc-500"
            )}
          >
            <DynamicIcon name={a.icon} size={18} />
          </div>
          <p className="text-xs font-semibold text-foreground leading-tight">{a.label}</p>
          <p className="text-[10px] text-gray-400 dark:text-zinc-400 leading-tight">{a.description}</p>
        </div>
      ))}
