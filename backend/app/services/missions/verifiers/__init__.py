...
from app.services.missions.verifiers import design, operate, quiz, submission

VERIFIER_KINDS = {"submission", "quiz", "checklist", "design", "operate", "external"}

__all__ = ["VERIFIER_KINDS", "design", "operate", "quiz", "submission"]
