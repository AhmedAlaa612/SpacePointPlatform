...
per-session assignment (8-4), the real-time WS transport (8-5), and
instructor live-play (8-7) so far; the student-facing surface lands in
8-8. Aggregate so main.py mounts one set of routes, same pattern
...
of the REST surface the others cover.
"""
